...
\begin{itemize}
    ...
    \begin{itemize}
        \item Tempo: O(|V|²), onde |V| é o número de vértices no grafo
        \item Espaço: O(|V|) para armazenar os conjuntos de vértices
        \item O loop principal executa no máximo |V| vezes
        \item Para cada iteração, visitamos todos os vértices não cobertos
    \end{itemize}
    
    \item \textbf{Cobertura Máxima:}
    \begin{itemize}
        \item Tempo: O(p|V|), onde p é o número máximo de câmeras
        \item Espaço: O(|V|) para armazenar os conjuntos de vértices
